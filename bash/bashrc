...
#Sync commands
alias sync_music='rsync -avz --progress --size-only --rsh=ssh slick.local:~/Music/ ~/Music/'
alias sync_cl='rsync -avz --progress --size-only --rsh=ssh slick.local:'~/Code\ Library/' ~/Code\ Library/'
...
# Subversion & Diff ------------------------------------------------
export SV_USER='nate'  # Change this to your username that you normally use on subversion (only if it is different from your logged in name)
